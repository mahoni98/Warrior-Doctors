...
namespace Lean.Touch
{
	...
	public class LeanManualTranslate : MonoBehaviour
	{
		...
		public static LeanManualTranslate unit;
		private void Awake()
		{
			unit = this;
		}
		...
		[SerializeField] PlayerSwipe ps;
		protected virtual void Update()
		{
			var factor = LeanTouch.GetDampenFactor(Dampening, Time.deltaTime);
			var newDelta = Vector3.Lerp(remainingDelta, Vector3.zero, factor*100f);

			ps.swipe -= ((remainingDelta - newDelta) / 10f);
